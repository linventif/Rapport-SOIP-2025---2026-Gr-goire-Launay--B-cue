...
Etant données mes études en MIAGE, le stage peut être pluridisciplinaire, donc autemps de la part techniques data scientist, développeur back / front / fulstack
...
La périodes envisagée nous est imposée par le cursus universitaire, de
...
Nous avons eu aussi un echange avec un ancien étudiant ayant effectué une mobilité internationale, ce qui a permis d'avoir un retour d'expérience concret.
Les planing et les deadlines pour les candidatures ont été clairement expliqués.
...
Nous avons les différentes type de réseaux : personnel, professionnel, académique, hobby, etc.
